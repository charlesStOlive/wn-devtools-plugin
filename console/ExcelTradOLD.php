...
class ExcelTradXXX extends GeneratorCommand
{
    ...
    protected function createExcel() {
        ...
        \Excel::store(new \Waka\DevTools\Classes\Exports\ExportAll($allLanfFiles, $this->arrayLangs ), $this->getExcelFileName());
    }
    ...
    protected function importExcel() {
        ...
        $importExcel = new \Waka\DevTools\Classes\Imports\ImportLang($langFiles, $this->arrayLangs);
